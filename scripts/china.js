...
var marker = new mapboxgl.Marker(myCustomMarker).setLngLat([82.0614041508079,38.67396522673533]).addTo(map1);
...
function getAPIdata() {
  ...
  var request1 = 'https://api.openweathermap.org/data/2.5/weather?appid=3ab1fa1e3405dbe544c86d5a6c21f87b&q=xinjiang';
